...
export class SchedulerGuestAssignedCardsComponent {
	...
	pairsPredicate	(): (guestDrag: CdkDrag, hostDrop: CdkDropList) => any {
		return (guestDrag: CdkDrag, hostDrop: CdkDropList) => {					// console.log('Guest Drag Object:', guestDrag); // console.log('Guest Drag Object:', guestDrag, '\n\nHost Target(s) Object:', hostDrop); // console.log('Host Target(s) Object:', hostDrop);
			const guests: any[] = [];
